...
const char * objectFileName = "sphere.obj";
...
vec3 defaultCameraPosition = vec3(0.0f, 3.0f, 3.0f);
...
//float lightPosition[maxNumLightSources][4] = { { 1.0f, 1.0f, 1.0f, 1.0f } };
//float lightDirection[maxNumLightSources][4] = { { 0.0f, 0.0f, 0.0f, 1.0 } };
//float lightDiffuse[maxNumLightSources][4] = { { 1.0f, 1.0f, 1.0f, 1.0f } };
//float lightSpecular[maxNumLightSources][4] = { { 1.0f, 1.0f, 1.0f, 1.0f } };
//float lightAmbient[maxNumLightSources][4] = { { 0.2f, 0.2f, 0.2f, 1.0f } };
//float lightConstantAttenuation[maxNumLightSources] = { 1.0f };
//float lightLinearAttenuation[maxNumLightSources] = { 1.0f };
//float lightQuadraticAttenuation[maxNumLightSources] = { 1.0f };
//float spotlightInnerCone[maxNumLightSources] = { 0.3f }; // inner cone cutoff angle (in radians)
//float spotlightOuterCone[maxNumLightSources] = { 2.0f }; // spotlight cutoff angle (in radians)
//int lightType[maxNumLightSources] = { 1 }; // default point light source
//
...
float lightPosition[maxNumLightSources][4] = { { 1.0f, 1.0f, 1.0f, 1.0f } ,{ -1.0f, 1.0f, 1.0f, 1.0f } };
float lightDirection[maxNumLightSources][4] = { { 0.0f, 0.0f, 0.0f, 1.0 } ,{ 0.0f, 0.0f, 0.0f, 1.0 } };
float lightDiffuse[maxNumLightSources][4] = { { 1.0f, 1.0f, 1.0f, 1.0f },{ 1.0f, 1.0f, 1.0f, 1.0f } };
float lightSpecular[maxNumLightSources][4] = { { 1.0f, 1.0f, 1.0f, 1.0f },{ 1.0f, 1.0f, 1.0f, 1.0f } };
float lightAmbient[maxNumLightSources][4] = { { 0.0f, 0.0, 0.0f, 1.0f } ,{ 0.0f, 0.0, 0.0f, 1.0f } };
float lightConstantAttenuation[maxNumLightSources] = { 1.0f , 1.0f };
float lightLinearAttenuation[maxNumLightSources] = { 1.0f,1.0f };
float lightQuadraticAttenuation[maxNumLightSources] = { 0.1f ,0.1f };
float spotlightInnerCone[maxNumLightSources] = { 0.3f,0.3f }; // inner cone cutoff angle (in radians)
float spotlightOuterCone[maxNumLightSources] = { 2.0f ,2.0f}; // spotlight cutoff angle (in radians)
int lightType[maxNumLightSources] = { 1,1 }; // default point light source
